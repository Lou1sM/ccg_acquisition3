...
#    print "pC for ",cat.toString()," is ",pC
    ...
    print(pC, ":", pLgivenC, "  ", end=' ', file=outputFile)       
...
#    print "norm is ",norm," for ",posType
    for p in probList:
        #print "p is ",p
        if norm==0.0: print(1.0/len(probList), ' ', end=' ', file=outputFile)
        else: print(p/norm, ' ', end=' ', file=outputFile)
